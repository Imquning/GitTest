...
public class NDensity {
    ...
    public static float defaultWidth = 375;
    public static float defaultHeight = 2000 / 3; // 375*2/3*1000/375
//    public static float defaultWidth = 500;
//    public static float defaultHeight = 8000 / 9; // 500*2/3*1000/375
    ...
    private static void setAppOrientation(@Nullable Activity activity, String orientation) {
        ...
        if (HEIGHT.equals(orientation)) {
            targetDensity = (appDisplayMetrics.heightPixels - barHeight) / defaultHeight;
        } else {
            targetDensity = appDisplayMetrics.widthPixels / defaultWidth;
        }
    ...
    public static void setDefaultWidth(float defaultWidth) {
        NDensity.defaultWidth = defaultWidth;
    }
    ...
    public static void setDefaultHeight(float defaultHeight) {
        NDensity.defaultHeight = defaultHeight;
    }
}
